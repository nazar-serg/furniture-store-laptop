...
<div class="cart-page">
								...
								<td class="product-remove">
									<?php
										echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
											...
											sprintf(
												'<a href="%s" class="remove btn btn-danger" aria-label="%s" data-product_id="%s" data-product_sku="%s"><i class="fa fa-times-circle-o" aria-hidden="true"></i>
							</a>',
						...
						<tfoot>
							...
							<tr>
								<td colspan="6" class="text-end">
									<button type="submit"
										class="update-cart btn btn-outline-warning button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>"
										name="update_cart"
	...
	<div class="cart-page__right-column">
